...
const writeMethodGen = require('../method_generators/write')
const findMethodGen = require('../method_generators/find')
...
module.exports = (db, {
  ...
  const model = {
    ...
    // get: (doc) => {},
    find: findMethodGen(genModelFunc),
    ...
    write: writeMethodGen(genModelFunc),
  }
