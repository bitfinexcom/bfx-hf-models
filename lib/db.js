...
class HFDB {
   ...
   * @param {DBAdapter} args.adapter - database adapter. See
   *   {@link external:bfx-hf-models-adapter-sql} for an example, or the type
   *   definition itself for a listing of required logic.
   * @param {object} args.schema - database schema providing custom models on
   *   top of the builtins. See {@link external:bfx-hf-ext-plugin-bitfinex} for
   *   an example.
   */
